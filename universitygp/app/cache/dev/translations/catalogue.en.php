...
',
  ...
  array (
    ...
    'admin.title' => 'Title',
    'admin.logout' => 'Logout',
    'admin.form_submit_success' => 'Your changes have been saved.',
    'admin.form_submit_error' => 'There are errors in the submitted form!',
    'admin.secured.title' => 'Blog Administration',
    'admin.secured.index' => 'From this section you can manage your posts, categories blog, etc ...',
    'admin.category.title' => 'Category list',
    'admin.category.create' => 'Create new category',
    'admin.category.description' => 'Description',
    'admin.category.created' => 'Your categtory has been created.',
    'admin.category.title_edit' => 'Edit category',
    'admin.comment.title' => 'Edit Comment',
    'admin.comment.pseudo' => 'Name',
    'admin.comment.email' => 'Email',
    'admin.comment.comment' => 'Comment',
    'admin.comment.writes' => 'Writes',
    'admin.post.title' => 'Posts list',
    'admin.post.title_edit' => 'Edit post',
    'admin.post.published_at' => 'Post published on %date% at %time%',
    'admin.post.create' => 'Create a new post',
    'admin.post.created' => 'Created',
    'admin.post.modified' => 'Modified',
    'admin.post.view' => 'View',
    'admin.post.has_been_created' => 'Your post has been created.',
    'admin.post.edit' => 'Edit',
    'default.lastupdated_on' => 'Last updated at %date% at %time%',
    'default.no_comments' => 'There are no comments for this article',
    'default.comments' => '{0}|{1}%count% comment|]1,Inf[%count% comments',
    'default.no_article' => 'There is no article!',
    'default.readmore' => 'Read more',
    'default.comment_published_at' => 'On %date% at %time% %name% wrote',
    'default.comment.email.subject' => 'Publication of your comment',
    'default.comment.email.message' => 'You are receiving this email because a comment was posted on our blog.

We ask you to confirm your comment by clicking this link:

%url%

If the link is not clickable, please copy the above url in the address bar of your browser.

Reminder of your comment:
%message%

Link to the article in question:
%url_article%
',
    'default.comment.saved' => 'Your comment has been saved.',
    'default.comment.message_notice' => 'You will receive a message asking you to confirm its publication.',
    'default.comment.confirmed' => 'Your comment has been confirmed!',
    'default.comment.submit' => 'Submit',
    'default.comment.legend' => 'Comment on post',
    'form.comment.website' => 'Website',
    'form.comment.comment' => 'Comment',
    'form.comment.published' => 'Published',
    'form.category.title' => 'Title',
    'form.category.description' => 'Description',
    'form.category.parent' => 'Parent category',
    'form.post.title' => 'Title',
    'form.post.hang' => 'Hang',
    'form.post.categories' => 'Categorie(s)',
    'form.post.publication' => 'Published On',
  ),
));
