 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Gestion\OffreBundle\Entity\StageRepository")
 */
class Stage
{
    /**
    ...
    private $secteur;
    /**
     * @ORM\ManyToOne(targetEntity="Gestion\UserBundle\Entity\Entreprise",inversedBy="stages")
