...
namespace Gestion\CalendrierBundle\Tests\Controller;
...
class EvenementControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'gestion_calendrierbundle_evenementtype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'gestion_calendrierbundle_evenementtype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
